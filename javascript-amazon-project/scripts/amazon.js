...
// passing a callback to loadProducts
...
function renderProductsGrid() {
    ...
    document.querySelectorAll(".js-add-to-cart").forEach((button) => {
        ...
        button.addEventListener("click", () => {
            ...
            const addedTag = document.querySelector(`.js-added-to-cart-${productId}`);
            addedTag.classList.add("added-to-cart-active");

            clearTimeout(timeoutId);

            timeoutId = setTimeout(() => {
                addedTag.classList.remove("added-to-cart-active");
            }, 2000);
        });
    });
}
